...
Актуальный релиз: [0.5.0](https://github.com/JonnTikhomirov/xrmpe_united_defence_pack/releases/download/v0.5.0/xrMPE_United_Defence_Pack_0.5.7z)
...
- [Живая зона](https://ap-pro.ru/forums/topic/4023-zhivaya-zona-obt/)
  - Геометрия и текстуры для уровня df_center_pripyat
- Anomaly
...
- **Янтарь** (`df_yantar`) — Ученые защищают бункер от зомбированных и монстров, в конце дожидаются вертолета поддрежки. Доступны случайные тайники, зажигаемые костры, любое время суток.
- **Блокпост** (`df_escape`) — Военные защищают блокпост от монстров, в конце дожидаются вертолета поддрежки. Доступны случайные тайники, ночное освещение, любое время суток.
